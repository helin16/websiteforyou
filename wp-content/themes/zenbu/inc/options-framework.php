...
function optionsframework_page() {
	...
	<div class="proversion">
	  <h3>Upgrade to Pro version!</h3>
	   <a href="<?php echo esc_url('http://www.pwtthemes.com/theme/zenbu-responsive-wordpress-theme'); ?>" target="_blank" class="upgradepro">Upgrade to Pro</a>
	   <a href="<?php echo esc_url('http://www.pwtthemes.com/demo/zenbu'); ?>" target="_blank" class="donate">Demo</a>
